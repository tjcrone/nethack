...
get_clipboard () {
  pbpaste | grep -A1000 ${1} | gtail -n +2 | \
    grep -m 1 -B1000 'Amulets\|Weapons\|Armor\|Comestibles\|Scrolls\|Spellbooks\|Potions\|Rings\|Wands\|Tools\|Gems\|Iron balls\|(end)' | \
...
declare -a StringArray=("Amulets" "Weapons" "Armor" "Comestibles" "Scrolls" "Spellbooks" "Potions" "Rings" "Wands" "Tools" "Gems" "Iron balls")
