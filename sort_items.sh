...
get_clipboard () {
  pbpaste | grep -A1000 ${1} | gtail -n +2 | \
    grep -m 1 -B1000 'Weapons\|Armor\|Comestibles\|Scrolls\|Spellbooks\|Potions\|Wands\|Rings\|Tools\|Gems\|(end)' | \
...
declare -a StringArray=("Weapons" "Armor" "Comestibles" "Scrolls" "Spellbooks" "Potions" "Wands" "Rings" "Tools" "Gems")
